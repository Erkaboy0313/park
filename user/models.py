...
from django.db.models import Count,Sum,Aggregate,Avg,Q,F,Exists,OuterRef,Case,When

class CustomUser(AbstractUser, ModelWithTimeStamp):
    class UserTypeEnum(models.TextChoices):
        ADMIN = 'admin', _('Admin')
        DRIVER = 'driver', _('Driver')
        OWNER = 'owner', _('Owner') # over bo'lishi ham mumkun registratsiyadan o'tyotganda
