...
class FloorSeriarlizer(serializers.Serializer):
...
class RegisterParkingSerialzier(serializers.ModelSerializer):

    floors = serializers.ListField(child = FloorSeriarlizer(),write_only = True)
